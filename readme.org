...
In the concept of Kalman filter, additional unceratinty is introduced to the state-space representation and observation of the system:
...
Note that the last equation in the prediction procedure can also be written as:
